...
<html>
	...
	<link href='http://www.maintance.embajeans.store/assets/Gambar/Logo/logoemba.png' rel='shortcut icon'>
		...
		<div class="row main-page">
			...
			<div class="col-lg-12 col-md-12 col-xs-12">
				<div class="col-md-4 col-md-offset-4">
					<?php echo form_open('Login/regis', '');?>
					<div class="panel panel-default" style="border: groove;">
				      ...
				      <div class="panel-body">
						...
						<div class="col-md-12">
							<input type="text" name="usernama_depan" class="form-control" placeholder="Masukkan Nama Depan" required="">
						</div>
						<div class="col-md-12">
							<label>Nama Belakang</label>
						</div>
						<div class="col-md-12">
							<input type="text" name="usernama_belakang" class="form-control" placeholder="Masukkan Nama Belakang" required="">
						</div>
						<div class="col-md-12">
						...
						<div class="col-md-12">
							<input type="number" min="0" name="telephon" class="form-control" required="">
						</div>
						<div class="col-md-12">
							<label>Email</label>
						</div>
						...
						<div class="col-md-12">
							<input type="password" pattern=".{8,}" title="min 8 karakter" name="password" class="form-control" placeholder="****" required="">
						</div>
						<div class="col-md-12">
							<label>Re-Password</label>
						</div>
						<div class="col-md-12">
							<input type="password" name="repassword" pattern=".{8,}" title="min 8 karakter" class="form-control" placeholder="*****" required="">
						</div>

						<div class="col-md-6">
							<input type="submit" class="btn btn-warning" value="Daftar Baru">
						</div>
						<div class="col-md-6">
							<a href="<?php echo site_url('Login/');?>" class="btn btn-warning" target="_blank">Sign In</a>
						</div>
