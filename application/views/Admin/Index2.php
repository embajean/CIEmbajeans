...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown"><?php echo $sess['namadepan'];?><i class="fa fa-angle-down"></i></h4>
    ...
    <script src="<?php echo base_url('assets/admin/');?>assets/js/line-chart.js"></script>
    <!-- all bar chart activation -->
    <script src="<?php echo base_url('assets/admin/');?>assets/js/bar-chart.js"></script>
    <!-- all pie chart -->
    <script src="<?php echo base_url('assets/admin/');?>assets/js/pie-chart.js"></script>
    <!-- others plugins -->
