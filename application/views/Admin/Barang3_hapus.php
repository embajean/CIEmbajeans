                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <label>Gambar Depan <p style="color:red">(max 200kb)</p> <a href="#javascript(0);" id="appn_picture"><i class="fa fa-plus-circle"></i></a></label>
                                        <input id="uploadImage1" type="file" required="" name="gambar[]" onchange="PreviewImage1(event);">

                                        <div id="_addPict">
                                        </div>

                                       <!--  <img src="<?php echo base_url('assets/gambar/Blank-profile.png');?>" id="uploadPreviewBelakang" class="form-control img-responsive" style="width: 150px; height: 150px;">
                                        ...
                                        <img src="<?php echo base_url('assets/gambar/Blank-profile.png');?>" id="uploadPreviewSamping" class="form-control img-responsive" style="width: 150px; height: 150px;">
...
<script type="text/javascript">
   ...
   /*<img src='http://localhost/somnium/Ejeans/assets/gambar/Blank-profile.png' id='uploadImage2' class='form-control img-responsive' style='width: 150px; height: 150px;'><label>Gambar 2<p style='color:red'>(max 200kb)</p></label><input id='uploadImage2' type='file' required name='gambar[]' onchange='PreviewImage2();'>*/
     ...
     $(document).ready(function(){
         ...
         $("#appn_picture").click(function(event) {
            ...
            if(_picture <= 6){
             ...
             var _showPict = "<img src='<?php echo base_url('assets/gambar/Blank-profile.png');?>' id='uploadPreview"+_picture+"' class='form-control img-responsive' style='width: 150px; height: 150px;'><label>Gambar "+_picture+"<p style='color:red'>(max 200kb)</p></label><input id='uploadImage"+_picture+"' type='file' required name='gambar[]' onchange='PreviewImage"+_picture+"(event);'>";
