	...
	<div class="head-shop" id="bg-shop">
		...
		<div class="colorlib-shop">
			<div class="container">
				<div id="policy">
					<div class="row">
						<h2 class="text-center"><img src="<?php echo base_url('assets/gambar/logo/Store.png');?>"></h2>
						<div class="col-lg-4">
							<img src="<?php echo base_url('assets/Gambar/logo/phone.png');?>" class="img img-responsive">
						</div>

						<div class="col-lg-8">
										<h4>Customer Care</h4>
						<p style="text-align: justify;">Untuk menjamin layanan pelanggan, kami memberikan jaminan bahwa produk yang kami tawarkan merupakan produk 100% asli Indonesia dan berkualitas. Dengan berbagai bentuk penawaran seperti flash sale, produk rekomendasi dan juga produk pilihan terlaris.</p>

						<p>Jika Anda memerlukan bantuan kami, ingin mendapatkan solusi atau sekedar menyampaikan pendapat, saran serta kritik, Anda dapat menghubungi kami pada Live Chat 24 Jam, atau dapat menghubungi:<br>
						<br>
						<a href="http://line.me/ti/p/%40kon6703c" target="_blank" title="Klik Disini"><img src="<?php echo base_url('assets/gambar/logo/');?>1.png" style="height: 20px; color: black;"></a>@embajeans<br>
						Phone : 089-653-535-343
						<br>
						(Jam Operasional: Senin-Sabtu 09.00-16.00) </p>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-8">
							<h4>Privacy and Savety</h4>
						<p style="text-align: justify">Untuk tetap melindungi privasi dan keamanan pelanggan, kami senantiasa menjaga dan menghargai setiap data serta informasi pribadi pengguna situs <a href="http://www.embajeans.com">www.embajeans.com.</a>

						Dengan mengakses dan mempergunakan layanan dari Emba Jeans, pengguna menyatakan bahwa setiap data merupakan data yang benar dan sah. Pengguna juga menyatakan bahwa setuju kepada kebijakan dan privasi yang dimiliki oleh Emba Jeans.

						Dan untuk menjaga kualitas produk, kami akan menjaga kualitas bahan produk dari sebelum pengerjaan hingga barang sampai ke tangan Anda. </p>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-8">
							...
							<p style="text-align:justify;">Emba Jeans memberikan kemudahan bagi para seller yang ingin berkembang dan bekerja sama dengan kami, dengan melalui program partnership.
							Untuk pertanyaan seputar grosir dan reseller, Anda dapat menuju pilihan partnership pada beranda dan dapat mengisi data diri lengkap pada form yang telah disediakan.

							Dengan menjadi partnership Emba Jeans, terdapat beberapa hal yang akan didapatkan:<br>
							1. Reseller atau grosir akan mendapatkan harga yang lebih murah dibandingkan dengan harga eceran<br>
							2. Produk dijamin kualitasnya, sama juga dengan produk pada pembelian eceran</p>
						</div>
					</div>
