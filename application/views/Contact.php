  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
		...
		<div class="colorlib-shop">
			<div class="row foot" id="about">
				<div class="col-lg-5">
					<center class="center-store">
						<button class="btn btn-warning btn-store">CONTACT</button>
					</center>
				</div>
				<div class="col-lg-7">
					<img src="<?php echo base_url('assets/Gambar/contact.PNG');?>" class="img img-responsive">
				</div>
			</div>
					...
					<div class="container">
						<center>
							<ul class="colorlib-social-icons">
									<li><a href="https://www.facebook.com/embajeansid/" target="_blank"><img src="<?php echo base_url('assets/Gambar/Logo/');?>3.png" style="height: 55px; color: black"></a></li>
									<li><a href="https://www.instagram.com/embajeans/" target="_blank"><img src="<?php echo base_url('assets/Gambar/Logo/');?>2.png" style="height: 55px"></a></li>
									<li><a href="https://www.youtube.com/channel/UCdifDj9A6WToN6L6ZMw1bKQ" target="_blank"><img src="<?php echo base_url('assets/Gambar/Logo/');?>4.png" style="height: 55px; width: 60px"></a></li>
									<li><a href="http://line.me/ti/p/%40kon6703c" target="_blank"><img src="<?php echo base_url('assets/Gambar/Logo/');?>1.png" style="height: 55px"></a></li>
							</ul>
						</center>
					</div>
				</div>
