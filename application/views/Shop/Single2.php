										...
										<div class="thumbnail">
											...
											<?php
												...
												foreach ($gambar as $key_gambar => $value_gambar) {
													?>
													<div class="col-md-3">
														<a href="javascript:void(0);" id="pc<?php echo $key_gambar;?>"><img src="<?php echo base_url('uploads/'.$value_gambar->gambar_product);?>" class="img img-responsive"></a>
													</div>
								...
								<div class="col-md-6">
									<div class="desc">
										...
										<div class="price" style="color :grey; font-size: 15px;">
											...
											<select class="form-control" style="color: grey;" id="sel_stok" required>
...
<?php
	...
	$id = empty($session['id']) ? 0 : $session['id'];
?>

<script type="text/javascript">

	$('#review').load('<?php echo site_url("Review/get_review/$id_barang/$id");?>');
	...
	$(document).ready(function() {
		...
		?>
			$('#pc<?php echo $key_gambar;?>').click(function() {
				 ...
				 //$("#pc").attr("src","<?php echo base_url("uploads/$value_gambar->gambar_product");?>");
				 $("#pc<?php echo $key_gambar;?>").click(function(){
					$('#pc').css('background-image', 'url("<?php echo base_url('uploads/'.$value_gambar->gambar_product);?>")');
				});
		...
		$('#sel_stok').change(function() {
			var size = $('#sel_stok').val();
			var sku = '<?php echo $barangby->sku;?>';
			$.ajax({
				url: '<?php echo site_url('Shop/get_stok_single');?>',
				type: 'POST',
				data: {size: size, sku : sku},
