			...
			<!-- <div class="col-md-12"> -->
				<div class="product-name">
					<div class="one-forth text-center">
						<span>Product Details <span id='cart-jumlah'></span> </span>
					</div>
				...
				<div class="product-cart">
					<div class="one-forth">
						<div class="product-img" style="background-image: url(<?php echo base_url('uploads/'.$gambar[$key]->gambar_product);?>);">
						</div>
						<div class="display-tc">
							<h3><?php echo $value->barangnama;?></h3>
						</div>
					</div>
					<div class="one-eight text-center">
						<div class="display-tc">
					...
					<div class="one-eight text-center">
						<div class="display-tc">
							...
							<p id="pilih-ukuran<?php echo $key;?>">Silahkan Pilih Ukuran</p>
						</div>
					</div>
					<div class="one-eight text-center">
						<div class="display-tc">
					...
					<div class="one-eight text-center">
						<div class="display-tc">
							<a href="#javascript(0);" title="Hapus Cart" class="closed" id="delete-cart<?php echo $key;?>" data-id="<?php echo $value->id;?>" data-mac="<?php echo $mac;?>" data-user="<?php echo $session['id'];?>"></a>
						</div>
					</div>
				</div>
