...
<html>
	...
	<title>Cart Emba Jeans Store</title>
					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1" id="cartnavbar">
							<ul>
								...
								?>
								<li class="active"><a href="<?php echo site_url('cart/mycart');?>"><i class="icon-shopping-cart">(<?php echo $cart['jumlah'];?>)</i></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
						<a href="<?php echo site_url('Shop');?>" class="btn btn-warning">Kembali Belanja</a>
						<div id="notifications"><?php echo $this->session->flashdata('msg');?></div>
					</div>
				</div>
				<div id="cart-mycart" class="row row-pb-md"></div>
