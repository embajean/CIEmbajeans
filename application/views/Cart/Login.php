...
$idlogin = "EMB".$exp2[0].$exp2[1].$exp2[2].$exp3[0].$exp3[1].$exp3[2];
		...
		<div class="row main-page">
			<div class="col-lg-12 col-md-12 col-xs-12">
				<div class="col-md-4 col-md-offset-4">
					...
					<?php echo form_open('login/ProcesAsGuest', '');?>
					<div class="panel panel-default" style="border: groove;">
				      <div class="panel-heading"><h4 class="text-center">Sign In as Guest</h4></div>
				      <div class="panel-body">
				      	<div class="col-md-12">
				      		<label>ID GUEST</label>
				      	</div>
				      	<div class="col-md-12">
				      		<input type="text" name="id" class="form-control" value="<?php echo $idlogin;?>" readonly>
				      	</div>
				      	<div class="col-md-12">
				      		<label>Nama</label>
				      	</div>
				      	<div class="col-md-12">
				      		<input type="text" name="namadepan" class="form-control" value="" required="" placeholder="Nama">
				      	</div>
				      	<div class="col-md-12">
				      	...
				      	<div class="col-md-12">
				      		<input type="date" required name="tanggal_lahir" id="tanggal_lahir" max="<?php echo $now;?>" class="form-control">
				      	</div>
				      	<div class="col-md-12">
				      		<label>Alamat</label>
				      	</div>
